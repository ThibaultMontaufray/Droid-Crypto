...
namespace Droid_Cryptographie
{
    public static class Token
    {
        ...
        public static DateTime GetCreationDate(string token)
        {
        ...
        public static bool IsExpired(string token, TimeSpan validityLength)
        {
            DateTime dt = GetCreationDate(token);
            return (DateTime.Now - dt) > validityLength;
        }
